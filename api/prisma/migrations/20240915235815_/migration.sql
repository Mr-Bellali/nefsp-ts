...
CREATE TABLE `Profile` (
    ...
    `storeType` ENUM('Restaurant', 'Cafe', 'Buffet_restaurant', 'Takeout_restaurant', 'Sushi_restaurant', 'Hotel_Bakery', 'Pastry_shop', 'Supermarket', 'Beverage_shop', 'Butcher_shop', 'Fruit_vegetable_store', 'Other') NULL,
